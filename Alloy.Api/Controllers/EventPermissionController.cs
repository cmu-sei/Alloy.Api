...
public class EventPermissionsController : BaseController
{
    private readonly IAlloyAuthorizationService _authorizationService;

    public EventPermissionsController(IAlloyAuthorizationService authorizationService)
    {
    ...
    {
        var result = _authorizationService.GetEventPermissions();
        return Ok(result);
    }
}